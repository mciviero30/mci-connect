          ...
          <Card className="glass-card shadow-xl border-slate-200 mb-6">
            ...
            <CardContent className="p-0">
              ...
              <div className="mt-6 space-y-3 max-w-md ml-auto px-3 pb-4">
                ...
                <div className="flex justify-between items-center p-3 bg-slate-50 rounded-lg">
                  <div className="flex items-center gap-2">
                    <input type="checkbox" id="profit-target-quote" checked={profitTargetEnabled} onChange={e => setProfitTargetEnabled(e.target.checked)} className="w-3.5 h-3.5 accent-violet-600 cursor-pointer" />
                    <label htmlFor="profit-target-quote" className="text-xs font-medium text-slate-600 cursor-pointer select-none">
                      {language === 'es' ? 'Meta de ganancia:' : 'Profit Target:'}
                    </label>
                    {profitTargetEnabled && (
                      <div className="flex items-center gap-1">
                        <Input type="number" value={profitTargetPercent} onChange={e => setProfitTargetPercent(Math.max(0, Math.min(100, parseFloat(e.target.value) || 0)))} min="0" max="100" step="1" className="w-12 h-6 text-xs text-center border-violet-300 p-1" />
