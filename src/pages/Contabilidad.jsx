...
export default function Contabilidad() {
  ...
  return (
    <div className="p-4 md:p-8 min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
      <div className="max-w-7xl mx-auto">
        <PageHeader
          ...
          icon={DollarSign}
          actions={
            <Button onClick={() => setFormOpen(true)} size="lg" className="bg-gradient-to-r from-[#3B9FF3] to-[#2A8FE3] text-white shadow-lg">
