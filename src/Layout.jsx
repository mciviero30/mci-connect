      ...
      <div className="min-h-screen flex w-full bg-[#F8FAFC] dark:bg-[#181818]">
        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
          <motion.header 
            ...
            className="px-3 py-2.5 md:hidden flex-shrink-0 border-b border-slate-200/30 dark:border-slate-700/30 shadow-sm"
            style={{ background: 'linear-gradient(135deg, #E8F4FD 0%, #D4E9FA 100%)' }}
            >
