...
import MCIConnectLogo from "@/components/logos/MCIConnectLogo";
    ...
    <SidebarProvider>
      ...
      <div className="min-h-screen flex w-full bg-[#F8FAFC] dark:bg-[#181818]">
        ...
        <Sidebar className="border-none shadow-2xl bg-white dark:bg-slate-900">
          <SidebarHeader className="p-4 flex-shrink-0 border-b border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-r from-slate-50 to-white dark:from-slate-800 dark:to-slate-900">
            <MCIConnectLogo height={64} />
          </SidebarHeader>
