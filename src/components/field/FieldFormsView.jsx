  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-[#D4C85C]">Formularios</h1>
        <Button 
        ...
        <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Respuestas</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {formTemplates.length === 0 ? (
        <div className="bg-slate-800/30 border border-slate-700/50 rounded-2xl p-12 text-center">
          ...
          <p className="text-slate-400 mb-4">Crea formularios de inspección, seguridad o calidad</p>
          <Button 
            onClick={() => setShowCreate(true)}
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button 
                      variant="ghost" 
                      size="icon"
                      className="opacity-0 group-hover:opacity-100 text-slate-400 hover:text-white h-8 w-8"
                    >
      ...
      {submissions.length > 0 && (
        <div className="mt-8">
          <h3 className="text-lg font-semibold text-white mb-4">Respuestas Recientes</h3>
            ...
            {submissions.slice(0, 5).map((sub) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-white">{sub.form_name || 'Formulario'}</p>
            ...
            <div>
              ...
              <Select value={newForm.category} onValueChange={(v) => setNewForm({...newForm, category: v})}>
                ...
                <SelectContent className="bg-slate-800 border-slate-700">
                  ...
                  <SelectItem value="safety" className="text-white">Seguridad</SelectItem>
                  <SelectItem value="quality" className="text-white">Calidad</SelectItem>
