...
export default function QuoteDocument({ quote }) {
    ...
    return (
        <div className="bg-white p-10 max-w-4xl mx-auto shadow-lg print:shadow-none print:rounded-none print:mx-0 print:p-0 print:w-full font-sans">
            ...
            {/* Header con Logo Negro y Título a la Derecha */}
            <div className="px-10 py-6 -mx-10 -mt-10 mb-6 flex items-center justify-between">
                <div className="px-8 py-4 rounded-lg" style={{ background: 'linear-gradient(to right, #000000 0%, #4a4a4a 100%)' }}>
                    <img
                ...
                <h1 className="text-5xl font-bold tracking-wide text-slate-900" style={{ letterSpacing: '0.05em' }}>QUOTE</h1>
            </div>
            ...
            <div className="flex justify-end pt-4">
                <div className="w-64 space-y-2">
                    ...
                    <div className="px-4 py-3 rounded flex justify-between items-center border-t-2 border-slate-800" style={{ background: 'linear-gradient(to right, #f1f5f9 0%, #cbd5e1 100%)' }}>
