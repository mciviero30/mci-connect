...
import { Trash2, ChevronUp, ChevronDown, ChevronsUpDown, Check, Info, Plus, Clock, DollarSign, Grid3x3 } from "lucide-react";
              ...
              <div>
                {allowCatalogSelect && catalogItems.length > 0 ? (
                  <Popover>
                    ...
                    <PopoverContent className="w-[350px] p-0 bg-white border shadow-xl" align="start">
