...
export const translations = {
  en: {
    ...
    // Status - UPDATED for Subcontractors
    active: "Active",
    inactive: "Inactive",
    pending: "Pending",
    approved: "Approved",
    ...
    employeeDirectory: "Subcontractor Directory",
    quickActions: "Quick Actions",
    myJobsThisWeek: "My Jobs This Week",
    
    // Employees - NOW SUBCONTRACTORS
    employeeManagement: "Subcontractor Management",
    newEmployee: "New Subcontractor",
    ...
    noTemporarilyOut: "No subcontractors temporarily out",
    employeeCreated: "Subcontractor created successfully",
    employeeUpdated: "Subcontractor updated successfully",
    employeeReactivated: "Subcontractor reactivated",
    archiveReason: "Reason for archiving:",
    terminationDate: "Termination date (YYYY-MM-DD):",
    reactivateConfirm: "Reactivate subcontractor",
    pauseDate: "Pause Date",
    returnDate: "Return Date",
    reason: "Reason",
    manageYourTeamMembers: "Manage your subcontractors",
    youHaveXPendingEmployees: "You have subcontractors pending W-9 review",
    searchEmployees: "Search subcontractors...",
    manualSync: "Manual Sync",
    addEmployee: "Add Subcontractor",
    syncing: "Syncing",
    viewProfile: "View Profile",
    editEmployee: "Edit Subcontractor",
    inviteEmployee: "Invite Subcontractor",
    ...
    employeeDeletedSuccessfully: "Subcontractor deleted successfully",
    failedToDeleteEmployee: "Failed to delete subcontractor",
    employeeArchived: "Subcontractor archived",
    failedToArchiveEmployee: "Failed to archive subcontractor",
    employeeRestoredToPending: "Subcontractor restored to pending",
    failedToRestoreEmployee: "Failed to restore subcontractor",
    ...
    onceAcceptedWillAppearDirectory: "Once accepted, subcontractor will appear in directory",
    employeeMarkedAsInvited: "Subcontractor marked as invited",
    ...
    confirmDeleteEmployeePermanently: "Are you sure you want to delete this subcontractor permanently?",
    confirmArchiveEmployee: "Are you sure you want to archive this subcontractor?",
    confirmRestoreEmployeeToPending: "Are you sure you want to restore this subcontractor to pending?",
    noActiveEmployeesFound: "No active subcontractors found",
    noPendingEmployees: "No pending subcontractors",
    noInvitedEmployees: "No invited subcontractors",
    noArchivedEmployees: "No archived subcontractors",
    unknownEmployee: "Unknown Subcontractor",
    nameNeedsConfigurationInstruction: "Name needs configuration. Click Edit to set first name and last name.",
    youHaveXDeletedEmployees: "You have deleted subcontractors",
    deletedAndBlocked: "Deleted & Blocked",
    allDataDeletedEmployeeBlocked: "All data deleted, subcontractor blocked from accessing the app",
    noDeletedEmployees: "No deleted subcontractors",
    ...
    // NEW: W-9 and Onboarding
    w9Required: "W-9 Required",
    w9Completed: "W-9 Completed",
    agreementRequired: "Agreement Required",
    agreementAccepted: "Agreement Accepted",
    agreementPending: "Agreement Pending",
    requiresW9Review: "Requires W-9 Review",
    onboardingPending: "Onboarding Pending",
    onboardingCompleted: "Onboarding Completed",
    sendOnboardingLink: "Send Onboarding Link",
    w9CompletedOn: "W-9 Completed on",
    agreementAcceptedOn: "Agreement Accepted on",
    cannotAssignTeamWithoutW9: "⚠️ Cannot assign team without completed W-9",
    cannotActivateWithoutW9: "⚠️ Cannot activate without completed W-9 and Agreement",
    w9ValidationWarning: "W-9 and Agreement must be completed before activation",
    fiscalStateMismatch: "⚠️ Fiscal state doesn't match team location",
    w9RequiredForTeam: "Complete W-9 first to assign team",
    ...
    allEmployeeStats: "All Subcontractor Stats",
    rank: "Rank",
    ...
    allEmployees: "All Subcontractors",
    dailyBreakdown: "Daily Breakdown",

    selectEmployee: "Select Subcontractor",
    ...
    employeeWillReceiveTwoEmails: "Subcontractor will receive 2 emails: one from us and one from Base44 system",
    ...
    employeesActivated: "subcontractors automatically activated after registration",
    ...
    employeeCanAccessAppAgain: "The subcontractor will be able to access the app again",
    ...
    employeeWillReceiveEmail: "Subcontractor will receive email from Base44",
  ...
  es: {
    ...
    employeeDirectory: "Directorio de Subcontratistas",
    quickActions: "Acciones Rápidas",
    myJobsThisWeek: "Mis Trabajos Esta Semana",
    
    // Employees - NOW SUBCONTRACTORS
    employeeManagement: "Gestión de Subcontratistas",
    newEmployee: "Nuevo Subcontratista",
    inviteSubcontractor: "Invitar Subcontratista",
    fullName: "Nombre Completo",
    email: "Email",
    phone: "Teléfono",
    position: "Puesto/Oficio",
    ...
    noTemporarilyOut: "No hay subcontratistas temporalmente fuera",
    employeeCreated: "Subcontratista creado exitosamente",
    employeeUpdated: "Subcontratista actualizado exitosamente",
    employeeReactivated: "Subcontratista reactivado",
    archiveReason: "Razón para archivar:",
    terminationDate: "Fecha de terminación (AAAA-MM-DD):",
    reactivateConfirm: "Reactivar subcontratista",
    pauseDate: "Fecha de Pausa",
    returnDate: "Fecha de Retorno",
    reason: "Razón",
    manageYourTeamMembers: "Gestiona tus subcontratistas",
    youHaveXPendingEmployees: "Tienes subcontratistas pendientes de revisar W-9",
    searchEmployees: "Buscar subcontratistas...",
    manualSync: "Sincronización Manual",
    addEmployee: "Agregar Subcontratista",
    syncing: "Sincronizando",
    viewProfile: "Ver Perfil",
    editEmployee: "Editar Subcontratista",
    inviteEmployee: "Invitar Subcontratista",
    ...
    employeeDeletedSuccessfully: "Subcontratista eliminado exitosamente",
    failedToDeleteEmployee: "Error al eliminar subcontratista",
    employeeArchived: "Subcontratista archivado",
    failedToArchiveEmployee: "Error al archivar subcontratista",
    employeeRestoredToPending: "Subcontratista restaurado a pendiente",
    failedToRestoreEmployee: "Error al restaurar subcontratista",
    ...
    onceAcceptedWillAppearDirectory: "Una vez aceptado, el subcontratista aparecerá en el directorio",
    employeeMarkedAsInvited: "Subcontratista marcado como invitado",
    ...
    confirmDeleteEmployeePermanently: "¿Estás seguro de que quieres eliminar este subcontratista permanentemente?",
    confirmArchiveEmployee: "¿Estás seguro de que quieres archivar este subcontratista?",
    confirmRestoreEmployeeToPending: "¿Estás seguro de que quieres restaurar este subcontratista a pendiente?",
    noActiveEmployeesFound: "No se encontraron subcontratistas activos",
    noPendingEmployees: "No hay subcontratistas pendientes",
    noInvitedEmployees: "No hay subcontratistas invitados",
    noArchivedEmployees: "No hay subcontratistas archivados",
    unknownEmployee: "Subcontratista Desconocido",
    nameNeedsConfigurationInstruction: "El nombre necesita configuración. Haz clic en Editar para establecer nombre y apellido.",
    youHaveXDeletedEmployees: "Tienes subcontratistas eliminados",
    deletedAndBlocked: "Eliminado y Bloqueado",
    allDataDeletedEmployeeBlocked: "Todos los datos eliminados, subcontratista bloqueado del acceso a la app",
    noDeletedEmployees: "No hay subcontratistas eliminados",
    ...
    // NEW: W-9 and Onboarding
    w9Required: "W-9 Requerido",
    w9Completed: "W-9 Completado",
    agreementRequired: "Acuerdo Requerido",
    agreementAccepted: "Acuerdo Aceptado",
    agreementPending: "Acuerdo Pendiente",
    requiresW9Review: "Requiere Revisión W-9",
    onboardingPending: "Onboarding Pendiente",
    onboardingCompleted: "Onboarding Completado",
    sendOnboardingLink: "Enviar Link de Onboarding",
    w9CompletedOn: "W-9 Completado el",
    agreementAcceptedOn: "Acuerdo Aceptado el",
    cannotAssignTeamWithoutW9: "⚠️ No se puede asignar equipo sin W-9 completado",
    cannotActivateWithoutW9: "⚠️ No se puede activar sin W-9 y Acuerdo completados",
    w9ValidationWarning: "El W-9 y Acuerdo deben completarse antes de activar",
    fiscalStateMismatch: "⚠️ El estado fiscal no coincide con la ubicación del equipo",
    w9RequiredForTeam: "Completa el W-9 primero para asignar equipo",
    onboardingLink: "Enlace de Onboarding",
    copy: "Copiar",
    confirmProceed: "¿Deseas proceder de todos modos?",
    ...
    topPerformers: "Mejores Subcontratistas",
    allEmployeeStats: "Estadísticas de Todos los Subcontratistas",
    rank: "Rango",
    ...
    allEmployees: "Todos los Subcontratistas",
    dailyBreakdown: "Desglose Diario",
    selectEmployee: "Seleccionar Subcontratista",
    ...
    employeeWillReceiveTwoEmails: "El subcontratista recibirá 2 emails: uno nuestro y uno del sistema Base44",
    ...
    employeesActivated: "subcontratistas activados automáticamente después del registro",
    ...
    employeeCanAccessAppAgain: "El subcontratista podrá acceder a la app nuevamente",
    ...
    employeeWillReceiveEmail: "El subcontratista recibirá email de Base44",
