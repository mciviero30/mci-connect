...
const AVAILABLE_WIDGETS = {
  admin: [
    ...
    { id: 'ytd-revenue', title: 'YTD Revenue', icon: DollarSign, category: 'finance', size: 'small' },
    { id: 'total-customers', title: 'Total Customers', icon: Users, category: 'people', size: 'small' },
    { id: 'avg-job-profit', title: 'Avg Job Profit', icon: TrendingUp, category: 'finance', size: 'small' },
  ...
  employee: [
    ...
    { id: 'ytd-hours', title: 'YTD Hours', icon: Clock, category: 'time', size: 'small' },
    { id: 'ytd-pay', title: 'YTD Pay', icon: DollarSign, category: 'finance', size: 'small' },
