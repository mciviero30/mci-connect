...
const MCI_BRAND_STYLES = [
  { id: 'mci_pro', name: 'MCI Professional', icon: '💼', prompt: 'Professional corporate MCI executive portrait, deep navy blue professional studio background with MCI logo displayed elegantly on wall or backdrop behind person, high-end cinematic lighting with subtle rim light, modern business attire, confident expression, clean professional photography style. CRITICAL: MCI logo MUST be visible in background or on wall signage.' },
  { id: 'mci_construction', name: 'MCI Construcción', icon: '👷', prompt: 'Professional construction worker avatar, wearing WHITE hard hat with MCI logo prominently displayed on the front center of the helmet, HIGH-VISIBILITY ORANGE/YELLOW SAFETY VEST with reflective strips, construction site background, confident professional expression, industrial lighting, realistic photography style. CRITICAL: White hard hat with MCI logo on front center AND safety vest are MANDATORY, do not remove or change regardless of any other instructions.' },
  { id: 'mci_project_manager', name: 'Project Manager', icon: '📋', prompt: 'Construction project manager avatar, wearing WHITE hard hat with MCI logo on front center, HIGH-VISIBILITY SAFETY VEST, business casual attire underneath, holding blueprints or tablet, construction site office background with MCI signage visible, professional confident look, modern industrial photography. CRITICAL: White hard hat with MCI logo AND safety vest are MANDATORY.' },
  { id: 'mci_supervisor', name: 'Supervisor', icon: '👔', prompt: 'Construction supervisor avatar, WHITE hard hat with MCI logo prominently on front center, HIGH-VISIBILITY VEST with reflective strips, clipboard in hand, construction site background with MCI company signage visible, authoritative professional expression, industrial photography style. CRITICAL: White hard hat with MCI logo AND safety vest are MANDATORY.' },
  { id: 'mci_foreman', name: 'Foreman', icon: '🔧', prompt: 'Construction foreman avatar, WHITE hard hat with MCI logo on front center, ORANGE/YELLOW HIGH-VISIBILITY SAFETY VEST, tool belt visible, active construction site background with MCI branding on equipment or signage, experienced confident expression, realistic industrial photography. CRITICAL: White hard hat with MCI logo AND safety vest are MANDATORY.' },
  { id: 'mci_driver', name: 'Conductor', icon: '🚚', prompt: 'Professional truck driver avatar, wearing MCI branded cap with logo prominently displayed OR white hard hat with MCI logo, HIGH-VISIBILITY VEST, construction vehicle or truck with MCI logo on door in background, confident professional expression, outdoor industrial setting. CRITICAL: MCI branding MUST be visible on headwear AND vehicle.' },
  { id: 'mci_warehouse', name: 'Warehouse', icon: '📦', prompt: 'Warehouse worker avatar, wearing WHITE hard hat with MCI logo on front center, HIGH-VISIBILITY SAFETY VEST, warehouse storage facility background with MCI signage on walls or shelving, professional organized look, industrial lighting. CRITICAL: White hard hat with MCI logo AND safety vest are MANDATORY.' },
  { id: 'mci_hr', name: 'HR Manager', icon: '👥', prompt: 'HR professional avatar, business professional attire, modern office background with MCI logo displayed on wall, desk nameplate, or company signage behind person, warm approachable expression, professional corporate photography, clean business environment. CRITICAL: MCI logo MUST be visible in office setting.' },
  { id: 'mci_designer', name: 'Diseñador', icon: '🎨', prompt: 'Professional designer avatar, creative modern workspace with MCI logo visible on wall art, computer screen, or branded materials on desk, artistic professional look using MCI corporate blue palette (navy, slate, white), contemporary creative professional style, clean modern aesthetic. CRITICAL: MCI logo MUST be integrated naturally in workspace.' },
];
