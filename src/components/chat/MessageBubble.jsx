    ...
    <div className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
      <div className={`max-w-[65%] ${
        ...
        {message.reply_to_message && (
          <div className={`px-3 pt-2 pb-1.5 border-l-4 ${
            ...
            {Object.entries(reactions).map(([reactionName, users]) => {
              ...
              return (
                <button
                  ...
                  className={`px-1.5 py-0.5 rounded-full text-[10px] flex items-center gap-0.5 transition-all ${
                    iReacted
        ...
        <div className="px-3 pb-1.5 flex items-center justify-between">
          ...
          <div className="flex gap-0.5">
            <Button
              ...
              className={`h-5 px-1.5 ${isMe ? 'text-white hover:bg-blue-600' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'}`}
            >
