...
Deno.serve(async (req) => {
    try {
        ...
        // ==========================================
        // BILL TO & DATES - SIDE BY SIDE, COMPACT
        // ==========================================
        // Bill To (left)
        doc.setFontSize(8);
        ...
        if (quote.job_name) {
            ...
            const truncatedJobName = quote.job_name.length > 50 ? quote.job_name.substring(0, 47) + '...' : quote.job_name;
            ...
            if (quote.job_address) {
                ...
                doc.setFont(undefined, 'normal');
                doc.setTextColor(100, 116, 139);
                const truncatedAddress = quote.job_address.length > 80 ? quote.job_address.substring(0, 77) + '...' : quote.job_address;
        ...
        if (quote.notes) {
            ...
            // Limit notes to 3 lines maximum
